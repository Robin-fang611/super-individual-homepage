...
首轮程序化穹顶在真实预览中出现明显网格/像素感，水墨主体过少、空间留白失控，不满足本规格的“无破绽沉浸世界”标准。该实现不再作为视觉主路径。

新的 core 视觉由一张项目内 4K 水墨宇宙全景图承担：它贴在球体内侧，必须没有经纬网格、可见 UV 接缝或低清缩放痕迹。全景图提供每一个观察方向的深青黑、靛蓝、青色水墨星云、远处银色星河与克制的武侠气韵；它不承担交互信息。

在全景穹顶之前只保留少量真实三维体量：主墨河、两至三个大尺度墨云层、一个偏轴远景墨旋与极少数银色星芒。它们负责视差和飞行尺度，不能回到“大量小粒子 + 细线”构图。性能档位可降低全景贴图分辨率和隐藏非关键墨云，但不得移除全景主体或出现大面积空白。
